...
<html>
    ...
    <body>
        ...
        %>
        <%
            String nextpage = (String)session.getAttribute("nextpagetoken");
            try{
                URL url=new URL("https://maps.googleapis.com/maps/api/place/textsearch/json?pagetoken="+nextpage+"&key=AIzaSyDOltxIbBRRIWo48MxITOgSWl0Swl9L3xk"); 
